...
public class TinyDB {
    ...
    public void addUnluckySms(ServerSms serverSms){
        ArrayList<Object> list = getListObject("unluckySms", ServerSms.class);
        if(!list.contains(serverSms)) list.add(serverSms);
        putListObject("unluckySms", list);
    }
    public void removeUnluckySms(ServerSms serverSms){
        ArrayList<Object> list = getListObject("unluckySms", ServerSms.class);
        list.remove(serverSms);
        putListObject("unluckySms", list);
    }
